...
const GOOGLE_API_KEY = "AIzaSyBj6blVlIqe7IXTQ5KnJe5rObrDrWDG90I";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="ph.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="kk.jpg" alt="Gemini avatar">
...
const handleOutgoingMessage = () => {
    ...
    const outgoingMessageHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="kk.png" alt="User avatar">
            <p class="message__text"></p>
        </div>
